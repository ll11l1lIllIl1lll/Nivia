...
public class Config {
	...
	public static final String VERSION = "OptiFine_1.12.2_HD_U_G6_pre1";
	...
	public static String getVersionDebug() {
		...
		stringbuffer.append("OptiFine_1.12.2_HD_U_G6_pre1");
	...
	public static DisplayMode getLargestDisplayMode() {
		...
		if (adisplaymode != null && adisplaymode.length >= 1) {
			...
			if (desktopDisplayMode.getWidth() > displaymode.getWidth()) {
				...
				return desktopDisplayMode.getWidth() == displaymode.getWidth()
						&& desktopDisplayMode.getHeight() > displaymode.getHeight() ? desktopDisplayMode : displaymode;
			}
		} else {
			return desktopDisplayMode;
		}
	...
	private static DisplayMode[] getDisplayModes(DisplayMode[] p_getDisplayModes_0_, Dimension p_getDisplayModes_1_) {
		...
		for (int i = 0; i < p_getDisplayModes_0_.length; ++i) {
			...
			if ((double) displaymode.getWidth() == p_getDisplayModes_1_.getWidth()
					&& (double) displaymode.getHeight() == p_getDisplayModes_1_.getHeight()) {
				list.add(displaymode);
			}
		}
	...
	private static DisplayMode getDisplayMode(DisplayMode[] p_getDisplayMode_0_, DisplayMode p_getDisplayMode_1_) {
		if (p_getDisplayMode_1_ != null) {
			for (int i = 0; i < p_getDisplayMode_0_.length; ++i) {
				...
				if (displaymode.getBitsPerPixel() == p_getDisplayMode_1_.getBitsPerPixel()
						&& displaymode.getFrequency() == p_getDisplayMode_1_.getFrequency()) {
					return displaymode;
				}
			}
		}
	...
	public static Object[] addObjectToArray(Object[] p_addObjectToArray_0_, Object p_addObjectToArray_1_) {
		...
		int newLen = arrLen + 1;
		Object[] newArr = (Object[]) Array.newInstance(p_addObjectToArray_0_.getClass().getComponentType(), newLen);
	...
	public static Object[] addObjectToArray(Object[] p_addObjectToArray_0_, Object p_addObjectToArray_1_,
		...
		Object[] newArr = (Object[]) Array.newInstance(p_addObjectToArray_0_.getClass().getComponentType(),
				list.size());
	...
	public static Object[] addObjectsToArray(Object[] p_addObjectsToArray_0_, Object[] p_addObjectsToArray_1_) {
		...
		Object[] newArr = (Object[]) Array.newInstance(p_addObjectsToArray_0_.getClass().getComponentType(), newLen);
	...
	public static Object[] removeObjectFromArray(Object[] p_removeObjectFromArray_0_,
	...
	public static Object[] collectionToArray(Collection p_collectionToArray_0_, Class p_collectionToArray_1_) {
        ...
        Object[] array = (Object[])Array.newInstance(p_collectionToArray_1_, p_collectionToArray_0_.size());
		...
		if (minecraft.debug == mcDebugLast) {
			...
			if (i == j) {
				...
				for (int k1 = MathHelper.normalizeAngle(i - 1, along.length); k1 != j
						&& (double) j1 < 1.0E9D; k1 = MathHelper.normalizeAngle(k1 - 1, along.length)) {
					long l1 = along[k1];
